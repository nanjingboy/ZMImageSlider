...
- (IBAction)showImageSlider:(id)sender {
    NSArray *imageUrls = @[@"http://img.bimg.126.net/photo/qwLaXLhl3boN0bUPMGRPiA==/5704653352996391616.jpg",
    ...
    ZMImageSliderViewController *controller = [[ZMImageSliderViewController alloc] initWithOptions:0 imageUrls:imageUrls];
